  ...
  try {
    ...
    function getOrCreateGlobalSheet(ss, name, headers, headerColor) {
      ...
      if (s.getLastRow() === 0) {
        ...
        headerRange.setBackground(headerColor || "#2563eb");
    ...
    if (data.action === "syncAll") {
      ...
      var sheet = getOrCreateGlobalSheet(ss, "Laporan KPI Sales", headers, "#2563eb");
...
export default function App() {
  ...
  if (!isAuthenticated && !customerMode) {
    return (
      <div className="min-h-screen bg-[#ffffff] text-[#0f172a] font-sans flex items-center justify-center p-4">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input 
                ...
                className="w-full bg-[#ffffff] border border-[#e2e8f0] px-4 py-3 rounded-xl text-sm font-semibold text-[#0f172a] focus:border-[#2563eb] focus:outline-hidden transition"
            ...
            <button 
              type="submit"
              className="w-full bg-[#2563eb] hover:bg-[#0f172a] text-white font-bold uppercase tracking-widest text-xs py-3.5 rounded-xl cursor-pointer transition shadow-md mt-6"
            >
              Masuk Sekarang
            </button>
          </form>
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#0f172a] font-sans selection:bg-[#2563eb] selection:text-white flex flex-col md:flex-row">
        ...
        {toast && (
          <motion.div
            ...
            className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-5 py-3 rounded-xl shadow-xl border text-sm font-semibold max-w-md ${
              toast.type === "success"
                ? "bg-[#ffffff] text-[#2563eb] border-[#64748b]/30 animate-pulse"
                : toast.type === "error"
                ? "bg-[#ffffff] text-rose-800 border-rose-200"
                : "bg-[#ffffff] text-[#64748b] border-[#e2e8f0]"
            }`}
          >
            {toast.type === "success" && <CheckCircle2 className="w-5 h-5 text-[#2563eb]" />}
      ...
      {!customerMode && (
        <aside 
          className={`hidden md:flex flex-col bg-[#ffffff] border-r border-[#e2e8f0] h-screen sticky top-0 shrink-0 transition-all duration-300 z-40 ${
        ...
        {!isSidebarCollapsed && (
          <div className="p-4 bg-[#e2e8f0]/20 border-b border-[#e2e8f0]/40 flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-[#2563eb] text-xs font-serif italic text-white flex items-center justify-center font-bold">
              AR
            </div>
        ...
        <div className="p-4 border-t border-[#e2e8f0] text-center text-[10px] text-[#64748b] shrink-0">
          {!isSidebarCollapsed && (
            <div className="flex flex-col gap-0.5">
              <p className="font-bold text-[#2563eb]">DKR SALES SYSTEM</p>
              <p className="font-mono text-[9px]">v1.4.0 • Live</p>
            </div>
          )}
          {isSidebarCollapsed && (
            <span className="font-mono font-bold text-[#2563eb] text-[10px]">1.4</span>
          )}
        </div>
      </aside>
      )}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {!customerMode && (
          <header className="bg-[#ffffff] border-b border-[#e2e8f0] md:hidden sticky top-0 z-30 shadow-xs">
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            <button
              ...
              className="p-2 hover:bg-[#e2e8f0]/50 text-[#2563eb] rounded-xl transition cursor-pointer border border-[#e2e8f0]"
            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center gap-3 ${
                    activeTab === "form" ? "bg-[#2563eb] text-[#ffffff]" : "bg-[#e2e8f0]/20 text-[#64748b]"
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center justify-between ${
                    activeTab === "loyalty" ? "bg-[#2563eb] text-[#ffffff] border border-[#2563eb]" : "bg-gradient-to-r from-amber-500/10 to-[#e2e8f0]/20 text-amber-900"
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center justify-between ${
                    activeTab === "claims" ? "bg-[#2563eb] text-[#ffffff] border border-[#2563eb]" : "bg-gradient-to-r from-emerald-500/10 to-[#e2e8f0]/20 text-emerald-900"
                  }`}
                >
                  <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center justify-between ${
                    activeTab === "kpisales" ? "bg-[#2563eb] text-[#ffffff]" : "bg-gradient-to-r from-rose-500/10 to-[#e2e8f0]/20 text-rose-900"
                  }`}
                >
                  <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center gap-3 ${
                    activeTab === "salesmen" ? "bg-[#2563eb] text-[#ffffff]" : "bg-[#e2e8f0]/20 text-[#64748b]"
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center gap-3 ${
                    activeTab === "customerData" ? "bg-[#2563eb] text-[#ffffff]" : "bg-[#e2e8f0]/20 text-[#64748b]"
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center gap-3 ${
                    activeTab === "products" ? "bg-[#2563eb] text-[#ffffff]" : "bg-[#e2e8f0]/20 text-[#64748b]"
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center justify-between ${
                    activeTab === "reports" ? "bg-[#2563eb] text-[#ffffff]" : "bg-[#e2e8f0]/20 text-[#64748b]"
                  }`}
                >
                  <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl text-left text-xs font-black uppercase tracking-wider flex items-center gap-3 ${
                    activeTab === "sheets" ? "bg-[#2563eb] text-[#ffffff]" : "bg-[#e2e8f0]/20 text-[#64748b]"
                  }`}
                >
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-[#ffffff] p-4 rounded-2xl border border-[#e2e8f0] shadow-xs">
            ...
            <span className="text-xl font-extrabold text-[#2563eb] block mt-1">Rp {grandTotalCollection.toLocaleString("id-ID")}</span>
          ...
          <div className="bg-gradient-to-br from-[#2563eb] to-[#0f172a] p-4 rounded-2xl text-[#ffffff] shadow-sm">
            <span className="text-xs font-bold block uppercase tracking-wider text-[#ffffff]/80">Database Salesman</span>
            <span className="text-xl font-extrabold block mt-1">{salesmen.length} Anggota</span>
            <span className="text-[10px] text-[#ffffff]/70 italic">Pilihan dropdown otomatis</span>
          </div>
        </section>
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "form" && (
            ...
            >
              ...
              <div className="w-full flex flex-col gap-6">
                ...
                <div className="bg-gradient-to-r from-[#2563eb] via-[#64748b] to-[#2563eb] text-[#ffffff] rounded-3xl p-6 shadow-sm flex items-center justify-between border border-[#e2e8f0]">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20">
                      <User className="w-7 h-7 text-[#ffffff]" />
                    </div>
                    <div>
                      <h2 className="text-xl font-serif italic font-bold tracking-tight uppercase">
                        Bantu Input Laporan
                      </h2>
                      <p className="text-[10px] text-[#ffffff]/85 font-semibold tracking-widest uppercase mt-0.5">
                        SALESMAN YANG DIINPUT: <span className="text-[#ffffff] font-bold underline decoration-dotted decoration-2 underline-offset-4 transition-all">{activeSalesman ? activeSalesman.name : "BELUM DIPILIH"}</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* THE PORTAL FORM */}
                <form onSubmit={handleSubmitReport} className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs flex flex-col gap-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#ffffff] border border-[#e2e8f0] rounded-xl px-4 py-3 text-sm focus:outline-hidden focus:ring-2 focus:ring-[#2563eb] focus:bg-white text-[#0f172a] font-medium transition"
                        required
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-[#64748b] uppercase tracking-widest mb-1.5 flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="text-[10px] font-bold text-[#2563eb] bg-[#e2e8f0]/55 hover:bg-[#e2e8f0] px-2.5 py-1 rounded-md flex items-center gap-1 uppercase transition"
                        >
                      ...
                      <select
                        ...
                        className="w-full bg-[#ffffff] border border-[#e2e8f0] rounded-xl px-4 py-3 text-sm focus:outline-hidden focus:ring-2 focus:ring-[#2563eb] focus:bg-white text-[#0f172a] font-semibold transition"
                        required
                      >
                    ...
                    <div className="w-full">
                      <label className="block text-xs font-bold text-[#64748b] uppercase tracking-widest mb-1.5 mt-4">
                        AREA *
                      </label>
                      <select
                        value={area}
                  ...
                  <div className="relative" ref={salesmanDropdownRef}>
                    ...
                    <div
                      ...
                      className="w-full bg-[#ffffff] border border-[#e2e8f0] rounded-2xl p-4 flex items-center justify-between cursor-pointer hover:border-[#64748b] hover:bg-[#ffffff]/50 transition duration-150"
                    >
                      <div className="flex items-center gap-3">
                    ...
                    <AnimatePresence>
                      {isSalesmanDropdownOpen && (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: 5 }}
                          className="absolute left-0 right-0 mt-2 bg-[#ffffff] border border-[#e2e8f0] rounded-2xl shadow-xl z-40 max-h-72 overflow-y-auto"
                        >
                          <div className="p-3 border-b border-[#e2e8f0] flex items-center gap-2 sticky top-0 bg-[#ffffff] z-10">
                            ...
                            {filteredSalesmen.length === 0 && (
                              <div className="p-6 text-center">
                                ...
                                <button
                                  ...
                                  className="mt-2 text-xs text-[#2563eb] hover:underline font-bold flex items-center justify-center gap-1 mx-auto"
                                >
                  ...
                  <div className="bg-[#ffffff] rounded-2xl p-4 border border-[#e2e8f0]/60">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-3">
                      ...
                      <div className="relative w-full sm:w-auto" ref={productPickerRef}>
                        <button
                          ...
                          className="w-full sm:w-auto px-4 py-2 bg-[#ffffff] border border-[#e2e8f0] rounded-xl text-xs font-bold text-[#2563eb] hover:bg-[#e2e8f0]/30 flex items-center justify-center gap-2 shadow-xs cursor-pointer transition"
                        >
                        ...
                        <AnimatePresence>
                          {isProductPickerOpen && (
                            <motion.div
                              ...
                              className="absolute right-0 mt-2 w-80 bg-[#ffffff] border border-[#e2e8f0] rounded-2xl shadow-xl z-50 overflow-hidden"
                            >
                              {/* Autocomplete Input Search */}
                              <div className="p-3 border-b border-[#e2e8f0] bg-[#ffffff] flex items-center gap-1.5">
                                <Search className="w-4 h-4 text-[#64748b]" />
                                <input
                                  type="text"
                    ...
                    {Object.keys(selectedProducts).length > 0 ? (
                      <div className="flex flex-col gap-2 max-h-48 overflow-y-auto">
                        {Object.entries(selectedProducts).map(([pId, qty]) => {
                          ...
                          if (!p) return null;
                          return (
                            <div key={pId} className="flex items-center justify-between bg-[#ffffff] px-3.5 py-2.5 rounded-xl border border-[#e2e8f0]">
                              <div>
                      ...
                      <div className="p-4 bg-[#ffffff] rounded-xl border border-[#e2e8f0] text-center text-[#64748b]/70 text-xs italic">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-[#ffffff] p-4 rounded-2xl border border-[#e2e8f0]">
                      ...
                      <input
                        ...
                        className="w-full bg-[#ffffff] text-center rounded-xl py-3 text-lg font-mono font-black text-[#2563eb] border border-[#e2e8f0] focus:outline-hidden focus:ring-2 focus:ring-[#2563eb]"
                        required
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#ffffff] border border-[#e2e8f0] rounded-xl px-4 py-3 text-sm focus:outline-hidden focus:ring-2 focus:ring-[#2563eb] focus:bg-white text-[#0f172a] transition"
                    />
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-2">
                    <button
                      ...
                      className="w-full bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] font-extrabold text-sm uppercase tracking-wider py-4 px-6 rounded-2xl transition duration-150 flex items-center justify-center gap-2.5 shadow-md cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmittingReport ? (
                        <>
          ...
          {activeTab === "salesmen" && (
            ...
            >
              ...
              <div className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs">
                <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                  ...
                  <button
                    ...
                    className="w-full md:w-auto px-5 py-3 bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] font-[#ffffff] font-bold text-xs uppercase tracking-wider rounded-xl transition duration-150 flex items-center justify-center gap-2 cursor-pointer shadow-xs"
                  >
                ...
                <div className="mt-6 bg-[#e2e8f0]/20 p-5 rounded-2xl border border-[#e2e8f0]">
                  <h4 className="text-xs font-black text-[#2563eb] uppercase tracking-widest mb-1.5 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    <div className="bg-[#ffffff] p-3.5 rounded-xl border border-[#e2e8f0]">
                      <span className="font-bold text-[#2563eb] block mb-1">1. Model Data (Schema)</span>
                    ...
                    <div className="bg-[#ffffff] p-3.5 rounded-xl border border-[#e2e8f0]">
                      <span className="font-bold text-[#2563eb] block mb-1">2. Penyimpanan (Database)</span>
                    ...
                    <div className="bg-[#ffffff] p-3.5 rounded-xl border border-[#e2e8f0]">
                      <span className="font-bold text-[#2563eb] block mb-1">3. Sinkronisasi UI Form</span>
              ...
              {/* SALESMAN DATA TABLE */}
              <div className="bg-[#ffffff] rounded-3xl border border-[#e2e8f0] shadow-xs overflow-hidden">
                      ...
                      {salesmen.map((s) => (
                        <tr key={s.id} className="hover:bg-[#e2e8f0]/20 transition">
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              <div className="w-9 h-9 rounded-lg bg-[#e2e8f0] text-[#2563eb] font-bold flex items-center justify-center text-xs">
                                {s.name.charAt(0)}
                              </div>
                              <div>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-center gap-3">
                              <button
                                ...
                                className="p-2 text-[#64748b] hover:text-[#2563eb] hover:bg-[#e2e8f0]/40 rounded-lg transition"
                                title="Edit Salesman"
                              >
          ...
          {activeTab === "products" && (
            ...
            >
              ...
              {sheetsScriptUrl ? (
                <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-2 w-full sm:w-auto">
                    <button
                      ...
                      className="flex-1 sm:flex-none bg-white hover:bg-gray-50 border border-[#e2e8f0] text-[#2563eb] text-xs font-black px-4 py-2.5 rounded-2xl flex items-center justify-center gap-2 transition cursor-pointer disabled:opacity-50"
                    >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-center gap-3">
                              <button
                                ...
                                className="p-2 text-[#64748b] hover:text-[#2563eb] hover:bg-[#e2e8f0]/35 rounded-lg transition"
                                title="Edit Produk"
                              >
                                <Edit2 className="w-4 h-4" />
                              </button>
          ...
          {activeTab === "reports" && (
            ...
            >
              ...
              <div className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                ...
                {filteredAuditReports.length > 0 && (
                  <button
                    ...
                    className="px-4 py-2 bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] text-xs font-bold uppercase tracking-wider rounded-xl transition flex items-center gap-1.5 self-start cursor-pointer md:self-auto shadow-sm"
                  >
              ...
              {/* Filter Area */}
              <div className="bg-[#ffffff] rounded-2xl p-4 border border-[#e2e8f0] shadow-xs flex flex-col md:flex-row gap-4">
              ...
              {filteredAuditReports.length > 0 ? (
                <div className="grid grid-cols-1 gap-4">
                  {filteredAuditReports.map((rep: any) => (
                    <div
                      key={rep.id}
                      className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs hover:border-[#64748b] transition-all duration-150 flex flex-col lg:flex-row lg:items-center justify-between gap-6"
                    >
                      {/* Left: General Info */}
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-4 gap-2 max-w-lg mb-3 mt-3">
                          ...
                          <div className="bg-[#e2e8f0]/60 p-2 rounded-lg text-center">
                            <span className="text-[10px] text-[#2563eb] font-bold block">EC</span>
                            <span className="text-sm font-mono font-black text-[#2563eb]">{rep.ec}</span>
                          </div>
                          <div className="bg-[#64748b]/20 p-2 rounded-lg text-center">
                            <span className="text-[10px] text-[#2563eb] font-bold block">SKU</span>
                            <span className="text-sm font-mono font-black text-[#2563eb]">{rep.skuTotal}</span>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row lg:flex-col items-start sm:items-center lg:items-end justify-between lg:justify-center gap-4 lg:text-right">
                        <div>
                          ...
                          <span className="text-lg font-mono font-black text-[#2563eb] block">
                ...
                <div className="bg-[#ffffff] rounded-3xl p-12 border border-[#e2e8f0] text-center text-[#64748b] max-w-sm mx-auto shadow-xs">
                  ...
                  <button
                    onClick={() => setActiveTab("form")}
                    className="mt-4 px-4 py-2 bg-[#2563eb] text-[#ffffff] rounded-lg text-xs font-bold transition cursor-pointer"
                  >
                    Buka Form Input
                  </button>
                </div>
                ...
                <div className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs">
                  ...
                  <hr className="border-[#e2e8f0] mb-4" />
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-[#64748b] uppercase tracking-wider mb-1.5 flex items-center justify-between">
                          ...
                          {sheetsScriptUrl !== "https://script.google.com/macros/s/AKfycbz2a1vnNlVwQl6z77-3b5LYgXZAhprIgH3a_JAl0El5GPPI8xiZZGPdGsapa_mM6S0DQA/exec" && (
                            <button
                              ...
                              className="text-[9px] font-black text-[#2563eb] hover:underline cursor-pointer"
                            >
                              Set Default Web App
                            </button>
                          )}
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-[#e2e8f0]/20 border border-[#e2e8f0] rounded-xl text-xs text-[#0f172a] focus:outline-none focus:border-[#2563eb] transition placeholder:text-[#64748b]/50 font-mono"
                        />
                      </div>
                      ...
                      <div className="p-2.5 bg-[#2563eb]/10 rounded-xl border border-[#e2e8f0]/50 space-y-1 mt-1">
                        <div className="flex flex-col gap-0.5">
                        ...
                        <div className="flex items-center justify-between text-[10px] mt-1 pt-1 border-t border-[#e2e8f0]/60">
                          ...
                          <a 
                            ...
                            target="_blank" 
                            rel="noreferrer"
                            className="font-mono text-[10px] text-[#2563eb] underline hover:text-[#0f172a] truncate max-w-[150px]"
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-[#ffffff] text-[#2563eb] border border-[#2563eb] hover:bg-[#2563eb] hover:text-[#ffffff] rounded-xl text-xs font-bold transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                    >
                      {testConnectionStatus === "testing" ? (
                        <>
                          <span className="w-3.5 h-3.5 border-2 border-[#2563eb] border-t-transparent rounded-full animate-spin"></span>
                          Menguji Koneksi...
                        </>
                      ) : (
                        <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-white border border-[#e2e8f0] rounded-2xl flex flex-col gap-2.5 shadow-2xs">
                      ...
                      <button
                        ...
                        className="w-full py-2 bg-[#2563eb] text-[#ffffff] hover:bg-[#0f172a] disabled:bg-[#64748b]/30 disabled:cursor-not-allowed rounded-xl text-xs font-bold transition flex items-center justify-center gap-2 cursor-pointer shadow-3xs"
                      >
                        {isSyncingAll ? (
                          <>
                ...
                <div className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#2563eb] text-[#ffffff] flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5">
                        1
                      </div>
                      <div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="w-full">
                        ...
                        <div className="relative bg-[#3A3A2C] rounded-2xl p-4 overflow-hidden border border-[#2563eb]/30 shadow-inner">
                          <button
                            onClick={() => {
                              navigator.clipboard.writeText(APPS_SCRIPT_CODE_STENCIL);
                              showToast("Kode Apps Script disalin ke clipboard!", "success");
                            }}
                            className="absolute right-3 top-3 text-[10px] bg-[#ffffff]/10 text-[#ffffff] hover:bg-[#ffffff]/20 font-bold px-3 py-1.5 rounded-lg flex items-center gap-1.5 transition cursor-pointer"
                          >
          ...
          {activeTab === "loyalty" && (
            ...
            >
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-[#ffffff] to-[#e2e8f0]/20 p-4 rounded-2xl border border-[#e2e8f0] shadow-xs">
                  ...
                  <span className="text-[10px] text-[#2563eb] font-semibold">Tersinkron di Portal</span>
                </div>
                
                <div className="bg-gradient-to-br from-[#ffffff] to-amber-500/5 p-4 rounded-2xl border border-[#e2e8f0] shadow-xs">
                ...
                <div className="bg-gradient-to-br from-[#ffffff] to-[#2563eb]/5 p-4 rounded-2xl border border-[#e2e8f0] shadow-xs">
                ...
                <div className="bg-gradient-to-br from-[#ffffff] to-[#64748b]/10 p-4 rounded-2xl border border-[#e2e8f0] shadow-xs">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-[#ffffff] p-5 rounded-3xl border border-[#e2e8f0] shadow-xs">
                    ...
                    <div className="max-h-[350px] overflow-y-auto pr-1.5 space-y-4">
                      <div>
                        ...
                        <button
                          ...
                          className="w-full bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] hover:text-white font-bold text-xs uppercase tracking-wider py-3 px-4 rounded-xl transition cursor-pointer flex items-center justify-center gap-2"
                        >
                          <Plus className="w-4 h-4" />
                      ...
                      <div className="border-t border-dashed border-[#e2e8f0] pt-4 space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[8.5px] bg-[#2563eb] text-amber-300 font-extrabold px-1.5 py-0.5 rounded uppercase font-mono tracking-wider">
                            QR CODE
                          </span>
                        </div>
                          ...
                          return (
                            <div className="bg-white p-2.5 rounded-2xl border border-[#e2e8f0] flex flex-col items-center justify-center text-center gap-2">
                              <img
                                ...
                                className="w-28 h-28 border-2 border-[#2563eb] rounded-xl shadow-xs"
                              />
                              ...
                              <div className="w-full space-y-1">
                                ...
                                <button
                                  ...
                                  className="w-full py-1.5 text-[9px] font-black bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] rounded-lg transition cursor-pointer"
                                >
...
function createCustomerProfilingForm() {
  ...
  Browser.msgBox("SUKSES! Google Form telah dibuat di Drive Anda & dihubungkan ke spreadsheet ini sebagai tab respon baru! Tautkan link form tersebut ke poster/pelanggan Anda.");
                                      ...
                                      className="absolute right-2 top-2 text-[8px] bg-[#ffffff]/20 text-[#ffffff] hover:bg-[#ffffff]/30 font-bold px-2 py-1 rounded-md transition cursor-pointer"
                                    >
                                      Salin Script
                                    </button>
...
{`function createCustomerProfilingForm() {
  ...
  form.setDestination(FormApp.DestinationType.SPREADSHEET, ss.getId());
                          ...
                          <button
                            ...
                            className={`w-full py-3 px-4 font-black rounded-xl transition cursor-pointer flex items-center justify-center gap-2 text-xs uppercase tracking-wider ${
                              isImportingGoogleForm
                                ...
                                : "bg-gradient-to-r from-amber-500 to-[#2563eb] text-white hover:opacity-95 shadow-md hover:shadow-lg"
                            }`}
                          >
                  ...
                  <div className="bg-[#ffffff] p-5 rounded-3xl border border-[#e2e8f0] shadow-xs relative overflow-hidden">
                      ...
                      <div className="space-y-3.5">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-white border border-[#e2e8f0] rounded-xl px-2.5 py-2 text-xs text-[#0f172a] font-semibold focus:outline-hidden focus:ring-1 focus:ring-[#2563eb]"
                          >
                            {customers.map(c => (
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full bg-white border border-[#e2e8f0] rounded-xl p-2 text-xs text-[#0f172a] placeholder:text-[#64748b]/70 focus:outline-hidden focus:ring-1 focus:ring-[#2563eb]"
                          />
                        </div>
                        ...
                        <button
                          ...
                          className="w-full bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] font-bold text-xs uppercase tracking-wider py-2.5 rounded-xl transition cursor-pointer"
                        >
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="bg-[#ffffff] rounded-3xl p-6 border border-[#e2e8f0] shadow-xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4.5">
                      ...
                      <span className="text-[10px] px-3 py-1 bg-[#ffffff] border border-[#e2e8f0] rounded-lg font-mono text-[#64748b] font-bold shrink-0 self-start sm:self-auto">
                            ...
                            {customers.map(c => {
                              ...
                              return (
                                <React.Fragment key={c.id}>
                                    ...
                                    <td className="py-3 px-3">
                                      <div className="flex flex-col gap-1">
                                        ...
                                        <div className="flex items-center gap-1.5 mt-0.5">
                                          ...
                                          <span className="text-[9px] text-[#64748b] bg-[#ffffff] border border-[#e2e8f0] px-1.5 rounded uppercase">
                                            {c.jenisToko}
                                          </span>
                                        </div>
                                      </div>
                                  ...
                                  <tr>
                                    <td colSpan={5} className="py-2.5 px-6 bg-[#ffffff]/60 border-b border-[#e2e8f0]/45">
                                      <div className="flex flex-col gap-1">
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-[#ffffff] p-6 rounded-3xl border border-[#e2e8f0] shadow-xs relative overflow-hidden">
                    ...
                    <div className="space-y-2.5">
                      {[...rewardMerchants, ...katalogHadiah].map(item => (
                        <div 
                          ...
                          className="p-3 bg-white border border-[#e2e8f0]/60 rounded-xl flex items-center justify-between gap-3 text-xs cursor-pointer hover:border-[#2563eb] transition"
                        >
                          <div>
          ...
          {activeTab === "kpisales" && (
            ...
            >
              ...
              <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-xs relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-[11px] leading-relaxed text-[#2563eb] mt-4">
                  <div className="bg-[#ffffff] border border-[#e2e8f0]/60 p-4 rounded-2xl flex flex-col gap-1">
              ...
              <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-xs relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-[11px] leading-relaxed text-[#2563eb] mt-4">
                ...
                <button
                  ...
                  className={`flex-grow sm:flex-grow-0 px-6 py-2.5 rounded-xl text-xs uppercase font-extrabold cursor-pointer transition flex justify-center items-center gap-2 ${
                    kpiSalesmanTab === "all" 
                      ...
                      : "text-[#2563eb] hover:bg-[#e2e8f0]/50 font-bold"
                  }`}
                >
                  <Users className="w-4 h-4" />
                  Semua Salesman
                    ...
                    <button
                      ...
                      className={`flex-1 sm:flex-none px-6 py-2.5 rounded-xl text-xs uppercase font-black cursor-pointer transition flex justify-center items-center gap-2 ${
                        kpiTabMode === "dashboard" 
                          ? "bg-[#2563eb] text-white shadow-xs" 
                          : "text-[#2563eb] hover:bg-[#e2e8f0]/50"
                      }`}
                    >
              ...
              <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full lg:w-auto grow">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#ffffff] border border-[#e2e8f0] text-[#0f172a] font-extrabold text-xs uppercase px-3 py-2.5 rounded-xl focus:outline-hidden cursor-pointer"
                      >
                    ...
                    <div>
                      {kpiTimeFrame === "all" && (
                        <div>
                          ...
                          <div className="text-xs font-bold text-[#2563eb] bg-[#e2e8f0]/20 px-3 py-2.5 rounded-xl border border-[#e2e8f0]/50">
                          ...
                          <div>
                            ...
                            <div className="flex gap-1.5">
                              <input
                                ...
                                className="grow bg-[#ffffff] border border-rose-200 text-rose-900 font-black text-xs px-3 py-2 rounded-xl focus:outline-hidden cursor-pointer h-10"
                              />
                              {kpiSelectedDate !== "ALL" && (
                                <button
                                  type="button"
                        ...
                        return (
                          <div>
                            ...
                            <select
                              ...
                              className="w-full bg-[#ffffff] border border-rose-200 text-rose-900 font-extrabold text-xs uppercase px-3 py-2.5 rounded-xl focus:outline-hidden cursor-pointer"
                            >
                    ...
                    return (
                      <div className="col-span-full text-center p-10 bg-rose-500/5 border border-dashed border-rose-200 rounded-3xl space-y-4">
                        ...
                        <p className="text-xs text-[#64748b] max-w-lg mx-auto leading-relaxed">
                          Sistem mendeteksi lembar sebar Google Sheets Anda masih kosong atau data belum ditarik. Silakan masukkan URL Apps Script di tab <strong className="text-[#2563eb]">Google Sheets Linker</strong> kemudian tekan tombol <strong className="text-rose-700">Tarik Data Real-time dari Google Sheets</strong> di bagian atas halaman ini untuk sinkronisasi.
                        </p>
                        <div className="flex flex-wrap justify-center gap-3">
                          ...
                          <button
                            type="button"
                            onClick={() => setKpiDataSource("local")}
                            className="bg-[#2563eb] hover:bg-[#0f172a] text-white font-extrabold text-[11px] uppercase tracking-wider px-5 py-2.5 rounded-xl transition cursor-pointer"
                          >
              ...
              {kpiTabMode === "goals" && (
                <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-xs animate-in fade-in slide-in-from-bottom-4 space-y-6">
                  <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#e2e8f0] pb-4">
                    <h3 className="text-base font-black text-[#2563eb] uppercase tracking-wider flex items-center gap-2">
                    ...
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b-2 border-[#e2e8f0]">
                          <th className="py-3 px-2 text-[10px] font-black text-[#2563eb] uppercase">Nama Salesman</th>
                          <th className="py-3 px-2 text-[10px] font-black text-[#2563eb] uppercase">Target TC</th>
                          <th className="py-3 px-2 text-[10px] font-black text-[#2563eb] uppercase">Target CP</th>
                          <th className="py-3 px-2 text-[10px] font-black text-[#2563eb] uppercase">Target EC</th>
                          <th className="py-3 px-2 text-[10px] font-black text-[#2563eb] uppercase">Target SKU</th>
                        </tr>
                      </thead>
                      <tbody>
              ...
              {kpiSalesmanTab !== "all" && (() => {
                ...
                return (
                  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    {/* PROFILE HERO CARD */}
                    <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                      <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <div className="bg-[#2563eb]/10 text-[#2563eb] text-xs font-black px-4 py-2 rounded-2xl flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-xs space-y-4">
                          <h4 className="text-xs font-black text-[#2563eb] uppercase tracking-wider flex items-center gap-1.5 border-b border-[#e2e8f0] pb-3">
                            <TrendingUp className="w-4 h-4 text-rose-600" />
                      ...
                      <div>
                        <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-sm space-y-4 stick top-6">
                          ...
                          <form onSubmit={handleAddNoo} className="space-y-4">
                            ...
                            <button
                              type="submit"
                              className="w-full bg-[#2563eb] hover:bg-[#0f172a] text-white font-black text-xs uppercase tracking-wider py-3.5 rounded-xl shadow-md hover:shadow-lg transition cursor-pointer flex justify-center items-center gap-1.5"
                            >
                        ...
                        <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-3xl p-6 shadow-sm mt-6 space-y-4">
                          <h4 className="text-xs font-black text-[#2563eb] uppercase tracking-wider flex items-center gap-1.5 border-b border-[#e2e8f0] pb-3">
                            ...
                            <div className="space-y-3 max-h-72 overflow-y-auto pr-1">
                              {salesmanReports.slice(0, 5).map(rep => (
                                <div key={rep.id} className="bg-white p-3 rounded-2xl border border-[#e2e8f0]/60 text-[11px] space-y-2">
                                  ...
                                  <div className="grid grid-cols-2 gap-1 text-[10px] text-[#2563eb]">
        ...
        {isCustomerModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0f172a]/30 backdrop-blur-xs">
            <motion.div
              ...
              className="bg-[#ffffff] rounded-3xl p-6 w-full max-w-lg border border-[#e2e8f0] shadow-2xl relative max-h-[90vh] overflow-y-auto"
            >
              <button
              ...
              <h3 className="text-base font-black text-[#2563eb] uppercase tracking-wider mb-1 flex items-center gap-2">
              ...
              <form onSubmit={handleSaveCustomerProfile} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-[#e2e8f0]/20 p-3.5 rounded-2xl border border-[#e2e8f0]/40">
                  ...
                  <div>
                    <label className="block text-[9px] font-black text-[#2563eb] uppercase tracking-wider mb-1">
                      Omzet Per Bulan *
                    </label>
                    <input
                      type="number"
                ...
                <div className="pt-2 flex justify-end gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2 text-xs font-bold text-white uppercase bg-[#2563eb] hover:bg-[#0f172a] rounded-xl shadow-xs transition cursor-pointer"
                  >
        ...
        {salesmanModal.isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0f172a]/30 backdrop-blur-xs">
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-[#ffffff] rounded-3xl p-6 w-full max-w-md border border-[#e2e8f0] shadow-2xl relative"
            >
              <button
              ...
              <form onSubmit={handleSaveSalesman} className="flex flex-col gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#ffffff] border border-[#e2e8f0] rounded-xl px-4 py-3 text-sm focus:outline-hidden focus:ring-2 focus:ring-[#2563eb] text-[#0f172a] uppercase font-bold"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#ffffff] border border-[#e2e8f0] rounded-xl px-4 py-3 text-sm focus:outline-hidden focus:ring-2 focus:ring-[#2563eb] text-[#0f172a]"
                  />
                </div>
                ...
                <div className="flex gap-2.5 pt-2">
                  <button
                    type="submit"
                    className="flex-1 bg-[#2563eb] hover:bg-[#0f172a] text-[#ffffff] font-bold text-xs uppercase tracking-wider py-3 rounded-xl transition cursor-pointer"
                  >
                    Simpan ke DB
                  </button>
                  <button
              ...
              >
                ...
                <div className="flex gap-2.5">
                  <button
                    ...
                    className="flex-1 bg-rose-600 hover:bg-rose-700 text-[#ffffff] font-bold text-xs uppercase tracking-wider py-3 rounded-xl transition cursor-pointer shadow-sm shadow-rose-600/10"
                    type="button"
                  >
                    Ya, Hapus Permanen
                  </button>
      ...
      {/* --- FOOTER DESCRIPTOR --- */}
      <footer className="bg-[#ffffff] border-t border-[#e2e8f0] mt-12 py-8 text-center text-xs text-[#64748b]">
        <div className="max-w-2xl mx-auto px-4 flex flex-col gap-2">
          <p className="font-bold text-[#2563eb] uppercase tracking-widest">
